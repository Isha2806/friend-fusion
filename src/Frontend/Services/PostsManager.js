...
export const cloudinaryImageFetcher = async (mediaNewPost) => {
  ...
  dataForCloudinary.append("upload_preset", "mhw53avk");
  dataForCloudinary.append("cloud_name", "dyoerntpz");
  const urlToReturn = fetch(
    "https://api.cloudinary.com/v1_1/dyoerntpz/image/upload",
    {
      method: "post",
  ...
  console.log("Inside imaged",urlToReturn);
  return urlToReturn;
};
